      ...
      <section class="jumbotron text-center">
        <div class="container">
          ...
          <p class="lead text-muted">
            ...
            Trim, Window Install, Closets and Mudrooms, Customer Hearths,
            Built-In Shelving, Touch-up painting, and LVT floors,
          </p>
          <div class="btn-group">
                ...
                <div class="card-body row-md-8">
                  <div class="card_text">
                    ...
                    <p class="card-text">
                      ...
                      precision and care. Whether you need new cabinets fitted
                      or old ones replaced, we’ll make sure they’re level,
                      secure, and ready for everyday use.
                    </p>
                    <div
                ...
                <div class="card-body row-md-8">
                  <div class="card_text">
                    ...
                    <p class="card-text">
                      ...
                      your home’s style while adding function and durability.
                      From simple stonework to detailed finishes, we’ll make
              ...
              <div class="card mb-4 box-shadow">
                ...
                <div class="card-body row-md-8">
                  <div class="card_text">
                    ...
                    <p class="card-text">
                      Add the final touches that make a room stand out. From
                      clean corners to detailed molding, we make sure every edge
                ...
                <div class="card-body row-md-8">
                  <div class="card_text">
                    ...
                    <p class="card-text">
                      ...
                      great. From sturdy front doors to smooth interior
                      installs, we make sure everything opens, closes, and locks
